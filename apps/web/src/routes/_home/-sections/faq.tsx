...
const crowdinUrl = "https://kavil.ink";
...
const getFaqItems = (): FAQItemData[] => [
	{
		question: t`Is CV Resume - Bachhoavanphong.com really free?`,
		answer: t`Yes! CV Resume - Bachhoavanphong.com is completely free to use, with no hidden costs, premium tiers, or subscription fees. It's open-source and will always remain free.`,
	},
	{
		question: t`How is my data protected?`,
		answer: t`Your data is stored securely and is never shared with third parties. You can also self-host CV Resume - Bachhoavanphong.com on your own servers for complete control over your data.`,
	},
	{
	...
	{
		question: t`Is CV Resume - Bachhoavanphong.com available in multiple languages?`,
		answer: (
			<Trans>
				Yes, CV Resume - Bachhoavanphong.com is available in multiple languages. You can choose your preferred language in the settings
	...
	{
		question: t`What makes CV Resume - Bachhoavanphong.com different from other resume builders?`,
		answer: t`CV Resume - Bachhoavanphong.com is free app, privacy-focused. Unlike other resume builders, it doesn't show ads, track your data, or limit your features behind a paywall.`,
	},
	{
