			...
			<div className="relative space-y-8">
				...
				>
					...
					<p className="text-muted-foreground leading-relaxed">
						<Trans>
							CV Resume - Bachhoavanphong.com continues to grow thanks to its vibrant community. This project owes its progress to
							numerous individuals who've dedicated their time and skills to make it better.
						</Trans>
					</p>
				</m.div>
			</div>
